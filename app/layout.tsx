...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      // favicon.ico will be generated or added manually
    ],
    shortcut: '/favicon.svg',
    // apple-touch-icon.png will be generated or added manually
  },
  appLinks: {
    ios: {
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* favicon.ico will be auto-generated by Next.js from favicon.svg if needed */}
